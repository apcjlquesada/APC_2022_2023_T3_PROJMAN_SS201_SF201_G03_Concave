    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td colspan="1" class="total-heading text-center"><span style="font-family: DejaVu Sans; sans-serif;">&#8369;</span> {{ Str::currency($without_vat) }} </td>
            </tr>
            <tr>
                <td colspan="5" class="total-heading">VAT 12%: </td>
                <td colspan="1" class="total-heading text-center"><span style="font-family: DejaVu Sans; sans-serif;">&#8369;</span> {{ Str::currency($vat) }} </td>
            </tr>
            <tr>
                <td colspan="5" class="total-heading">Delivery Fee: </td>
                <td colspan="1" class="total-heading text-center"><span style="font-family: DejaVu Sans; sans-serif;">&#8369;</span> {{ Str::currency($order->del_fee) }}</td>
            </tr>
            <tr>
                <td colspan="5" class="total-heading">Total Amount: </td>
                <td colspan="1" class="total-heading text-center"><span style="font-family: DejaVu Sans; sans-serif;">&#8369;</span> {{ Str::currency($grandTotal) }}</td>
            </tr>
        </tbody>
    </table>
