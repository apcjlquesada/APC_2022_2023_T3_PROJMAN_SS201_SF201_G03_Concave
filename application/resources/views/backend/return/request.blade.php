            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-2">Pending Return Requests</h4>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Pending Return Requests </h4>
                                ...
                                <tbody>
                                    ...
                                    @forelse ($order as $item)
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td><a id="ApproveBtn" href="{{ url('admin/approve/return/' . $item->id) }}"
                                                    class="btn btn-info btn-sm">Approve</a></td>
                                        </tr>
                                    @empty
                                        <tr>
