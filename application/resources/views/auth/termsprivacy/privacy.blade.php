                ...
                <div class="row w-100 mx-0">
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                            ...
                            <h2><strong>Privacy Policy for Torrecamps Marketing</strong></h2>
                            <div class="card-body">
                                <p>At eTorrecamps, accessible from www.etorrecamps.com, one of our main priorities is the
                                    privacy of our visitors. This Privacy Policy document contains types of information that
                                    is collected and recorded by eTorrecamps and how we use it.</p>
                                ...
                                <p>This Privacy Policy applies only to our online activities and is valid for visitors to
                                    ...
                                    eTorrecamps. This policy is not applicable to any information collected offline or via
                                ...
                                <p>The personal information that you are asked to provide, and the reasons why you are asked
                                    to provide it, will be made clear to you at the point we ask you to provide your
                                ...
                                <p>eTorrecamps follows a standard procedure of using log files. These files log visitors
                                ...
                                <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web
                                    ...
                                    eTorrecamps, which are sent directly to users' browser. They automatically receive your
                                ...
                                <p>Note that eTorrecamps has no access to or control over these cookies that are used by
                                    third-party advertisers.</p>

                                <h2>Third Party Privacy Policies</h2>

                                <p>eTorrecamps's Privacy Policy does not apply to other advertisers or websites. Thus, we
                                ...
                                <p>eTorrecamps does not knowingly collect any Personal Identifiable Information from
